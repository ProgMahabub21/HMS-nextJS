                        ...
                        <section className="mb-32 text-gray-800">
                            <div className="flex justify-center">
                                <div className="text-center lg:max-w-3xl md:max-w-xl">
                                    <h2 className="px-6 mb-12 text-3xl font-bold text-white">Contact us</h2>
                                </div>
                            </div>
                                        ...
                                        <div className="w-full px-3 mb-12 grow-0 shrink-0 basis-auto lg:w-6/12 lg:px-6">
                                            <div className="flex items-start">
                                                <div className="shrink-0">
                                                    <div className="flex items-center justify-center p-4 bg-blue-600 rounded-md shadow-md w-14 h-14">
                                                ...
                                                <div className="ml-6 grow">
                                                    ...
                                                    <p className="text-gray-500">techsupport@medlife.com</p>
                                                    <p className="text-gray-500">+1 222-567-89</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="w-full px-3 mb-12 grow-0 shrink-0 basis-auto lg:w-6/12 lg:px-6">
                                            <div className="flex items-start">
                                                ...
                                                <div className="ml-6 grow">
                                                    <p className="mb-1 font-bold">Hospital Support</p>
                                                    <p className="text-gray-500">support@medlife.com</p>
                                                    <p className="text-gray-500">+1 233-577-89</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="w-full px-3 mb-12 grow-0 shrink-0 basis-auto lg:w-6/12 lg:px-6">
                                            <div className="flex align-start">
                                                ...
                                                <div className="ml-6 grow">
                                                    <p className="mb-1 font-bold">Pharmacy</p>
                                                    <p className="text-gray-500">pharmacy@medlife.com</p>
                                                    <p className="text-gray-500">+1 244-577-89</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="w-full px-3 mb-12 grow-0 shrink-0 basis-auto lg:w-6/12 lg:px-6">
                                            <div className="flex align-start">
                                                ...
                                                <div className="ml-6 grow">
                                                    ...
                                                    <p className="text-gray-500">+1 288-567-89</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
